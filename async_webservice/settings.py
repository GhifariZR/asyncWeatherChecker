"""
Django settings for async_webservice project.
...
# (e.g. Heroku).
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-g@^i60ra%r+s^k646*vs68dgnu&+e7b0!$)4%ef$sr$5$8v6f*')
...
if not PRODUCTION:
    ALLOWED_HOSTS += ['.localhost', '127.0.0.1', '[::1]','35.209.55.48']
...
ROOT_URLCONF = 'async_webservice.urls'
...
WSGI_APPLICATION = 'async_webservice.wsgi.application'
